...
void send_runstop_key(void) {
  ...
  if (is_send_key) DigiKeyboard.sendKeyStroke(KEY_ENTER, MOD_CONTROL_RIGHT );
  DigiKeyboard.delay(50);
}
...
void send_scrshot_key(void) {
  DigiKeyboard.sendKeyStroke(0);
  DigiKeyboard.delay(50);
  if (is_send_key) DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(50);
}
...
void send_clearall_key(void) {
  DigiKeyboard.sendKeyStroke(0);
  DigiKeyboard.delay(50);
  if (is_send_key) DigiKeyboard.sendKeyStroke(KEY_DELETE, MOD_CONTROL_RIGHT );
  DigiKeyboard.delay(50);
}
